    ...
    <div className="feature">
      <div className="headertab">
        ...
        <Link to="/sadtracksCollections">
          {options ? (
            <div
              onClick={() => handleSelectAll(identifier)}
        ...
        {sadlists.map((song, idx) => (
          ...
          >
            <div className="image-container">
              ...
              {state1.showaddoption &&
                state1.optionidx === "amazon" + idx + 80 && (
                  <AddOptions
                    state1={state1}
                    dispatch={dispatch}
                    dispatch1={dispatch1}
