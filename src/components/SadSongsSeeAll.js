...
function SadSongsSeeAll({state, state1, dispatch, dispatch1, loggedin, favoriteSongs, addToFavorites, divRef}){
         ...
         {favoriteSongs.includes(song._id) ? (
           ...
           <ActionAddIcon style={{ color: 'white' }} />
                ...
                <div onClick={()=> {dispatch1({type : "showingaddoption", showaddoption: true, optionidx: song._id}); dispatch1({type : "playingall", 
                                            ...
                                            infodes : song.artist.length > 0 ? song.artist[0].description : "Soulful Sad Song", 
                                            infoid : song._id,
                                            infocount : 1,
