    ...
    return (
        <div className="feature">
            <div className="headertab">
                ...
                <Link to="/songs/happytracks/collections">{options ? <div onClick={() => handleSelectAll(identifier)} className="alloptions">
          <span className="all">SEE ALL</span>
            ...
            <div className={selectall ? "wrapper-all" : "wrapper"} ref={happySongContainerRef}>
                ...
                <ActionAddIcon />
                        ...
                        <div onClick={()=> {dispatch1({type : "showingaddoption", showaddoption: true, optionidx: "amazon"+idx+40}); dispatch1({type : "playingall", 
                ...
                <ActionMoreIcon />
                    ...
                    {state1.showaddoption && state1.optionidx === "amazon"+idx+40 && <AddOptions state1={state1} dispatch={dispatch} dispatch1={dispatch1} divRef={divRef} />}
