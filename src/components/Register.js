...
function Register() {
  ...
  let [stateSignUp, dispatchSignUp] = useReducer(
    reducerSignUp,
    initialStateSignUp
  );
      ...
      <div className="accbox">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              dispatchSignUp({ type: "handleNameInput", name: e.target.value })
            }
          ...
          <input
            ...
            className="passbox"
            type="password"
            value={stateSignUp.pass}
            onChange={(e) =>
              dispatchSignUp({ type: "handlePassInput", pass: e.target.value })
            }
            placeholder="Password"
          ></input>
          <div className="passdiv1">
            <nav className="i">i</nav>
            <nav className="pass-char">
          ...
          <input
            ...
            className="passbox"
            type="password"
            value={stateSignUp.rePass}
            onChange={(e) =>
              dispatchSignUp({
                type: "handleRepassInput",
          ...
          <br></br>
          <br></br>
          <button className="signbtn" onClick={(e) => handleSignup(e)}>
